...
export class GridFleet {
  ...
  getState() {
    ...
    return {
      ...
      balance,
      equity,
      availableForTrade: typeof this.ex.availableForTrade === 'number' ? round2(this.ex.availableForTrade) : null,
      availableForWithdrawal: typeof this.ex.availableForWithdrawal === 'number' ? round2(this.ex.availableForWithdrawal) : null,
      initialMargin: typeof this.ex.initialMargin === 'number' ? round2(this.ex.initialMargin) : null,
      balanceRefreshError: this.ex._balanceRefreshError ?? null,
      balanceRefreshAt: this.ex._balanceRefreshAt ?? null,
